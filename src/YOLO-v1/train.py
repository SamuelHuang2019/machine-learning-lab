...
if __name__ == '__main__':
    ...
    train_dataset = yoloDataset(root=file_root,list_file='label_train.txt',train=True,transform = [transforms.ToTensor()] )
    ...
    test_dataset = yoloDataset(root=file_root,list_file='label_test.txt',train=False,transform = [transforms.ToTensor()] )
